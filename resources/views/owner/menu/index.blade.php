            ...
            <div class="bg-white p-4 rounded-lg shadow-sm border border-gray-200 flex flex-col space-y-3">
                <div class="flex items-center space-x-4">
                    <div class="flex-shrink-0 h-16 w-16 bg-gray-100 rounded-lg overflow-hidden">
                        @if($product->image)
                            <img class="h-full w-full object-cover" src="{{ route('menu.image', $product->products_id) }}" alt="" onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                <div class="flex-shrink-0 h-10 w-10 bg-gray-100 rounded-full overflow-hidden">
                                    @if($product->image)
                                        <img class="h-full w-full object-cover" src="{{ route('menu.image', $product->products_id) }}" alt="" onerror="this.onerror=null; this.src='{{ asset('images/default-kopi.jpg') }}';">
                                    @else
                                        <div class="h-full w-full flex items-center justify-center text-gray-500">
