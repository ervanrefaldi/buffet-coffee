            ...
            @forelse($events as $event)
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                    <div class="h-40 w-full relative">
                        <img src="{{ asset('storage/' . $event->image) }}" alt="Event" style="width:100%; height:100%; object-fit:cover;" class="w-full h-full object-cover">
                        @php
                            $now = date('Y-m-d');
                    ...
                    @forelse($events as $event)
                        <tr>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <img src="{{ asset('storage/' . $event->image) }}" alt="Event" style="width:100%; height:100%; object-fit:cover;" class="h-16 w-24 object-cover rounded-md border border-gray-200">
                            </td>
                            <td class="px-6 py-4">
