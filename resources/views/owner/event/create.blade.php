...
@section('subtitle', 'Silakan isi form di bawah ini untuk menambahkan event baru.')

@section('content')
    <div class="max-w-3xl bg-white p-8 rounded-xl shadow-sm border border-gray-200">
        <form action="/owner/event" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
            ...
            <!-- Gambar -->
            <div>
                <label for="image" class="block text-sm font-medium text-gray-700">Banner / Gambar Event</label>
