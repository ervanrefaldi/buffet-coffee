...
@section('title', 'Kelola Akun Owner')
@section('subtitle', 'Daftar semua akun owner yang dapat mengelola sistem.')

@section('content')
    <div class="bg-white p-8 rounded-xl shadow-sm border border-gray-200">
        <div class="flex justify-between items-center mb-6">
            <h2 class="text-xl font-bold text-gray-800">Daftar Owner</h2>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            ...
                            <form action="{{ route('admin.destroy', $admin->users_id) }}" method="POST" class="inline-block" onsubmit="return confirm('Yakin ingin menghapus akun admin ini?');">
                                @csrf
                                @method('DELETE')
